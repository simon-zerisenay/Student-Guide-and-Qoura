...
(function ($, Apperyio, undefined) {
    ...
    function loginGoogleOnDevice(dbId, clientId) {
        ...
        window.plugins.googleplus.login(
            {},
            function (response) {
                externalLogin( deferred, "", "", dbId, clientId, "google", null, response.accessToken);
            },
            function (msg) {
    ...
    Apperyio.User = {
         ...
         * @param {string} deviceClientId   - Google client id, type "Android".
         ...
         * @returns {Object}
         */
        loginGoogle: function( deviceClientId, previewClientId, callbackUrl, dbId ) {
            if ( isPhoneGapApp() ) {
                return loginGoogleOnDevice(dbId, deviceClientId);
            } else {
